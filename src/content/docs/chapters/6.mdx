...
Finally finally, make sure to commit again for good measure.
...
The first item we have is a reference to a module within `nixpkgs`. This module is what the official installer is also based on, we'll use it to let us create an ISO of this NixOS config.
