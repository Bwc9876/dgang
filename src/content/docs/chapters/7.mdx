...
3. Next you can optionally set swap memory, if you do set this I'd recommend making it the size of physical memory you have.
   ...
   2. Press Enter
   3. Enter the size you desire for the swap partition. (e.g. `4G` for 4 GB)
...
This file is mostly just pointing NixOS to the proper disk partitions, but depending on your hardware it may also set some options.
